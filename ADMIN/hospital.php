...
$sql = "SELECT hospital_id , name , address ,email, phone  FROM hospitals LIMIT 10";
...
<body>
  <div class="container">
    <div class="row mb-4">
      <div class="col-12">
        <h2 class="text-center">HOSPITALS Management</h2>
      </div>
    </div>
                  ...
                  <tr id="row-<?= $user["hospital_id"] ?>">
                    ...
                    <td class="actions-cell">
                      ...
                      <button class="btn btn-sm btn-message"
                        onclick="showMessageModal(<?= $user['hospital_id'] ?>, '<?= addslashes($user['name']) ?>')">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Are you sure you want to delete <strong><span id="deleteUserName"></span></strong> (ID: <span
              id="deleteUserId"></span>)?</p>
          <div class="mb-3">
  ...
  <div class="modal fade" id="messageModal" tabindex="-1" aria-labelledby="messageModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Send message to <strong><span id="messageUserName"></span></strong> (ID: <span id="messageUserId"></span>):
          </p>
          <div class="mb-3">
