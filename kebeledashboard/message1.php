...
<body>
      ...
      <div id="messagesList">
        ...
        <div class="message-card">
          ...
          <div class="message-content">
            Please prepare the full case report for #45721 by end of day tomorrow. Include all witness statements and
            forensic analysis.
          </div>
        </div>
        ...
        <div class="message-card">
          ...
          <div class="message-content">
            As discussed in today's meeting, please coordinate with the forensic team to get those lab results. Let me
  ...
  <div class="modal fade" id="adminMessagesModal" tabindex="-1" aria-labelledby="adminMessagesModalLabel"
    aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="message-card">
            ...
            <div class="message-content">
              Please review the attached documents regarding Case #45721. We need your input on the suspect
              identification process. The deadline for submission is May 15th.
            </div>
          </div>
